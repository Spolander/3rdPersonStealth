...
//		public float ratioForce = 1f;
		...
		void Start()
		{
			...
			halfHorizontalResolution = horizontalResolution/5;
			halfVerticalResolution = verticalResolution/5;
		}

		void Update()
		{
			verticalResolution = (int)Mathf.MoveTowards(verticalResolution, halfVerticalResolution,Time.deltaTime*5);
			horizontalResolution = (int)Mathf.MoveTowards(horizontalResolution, halfHorizontalResolution, Time.deltaTime*5);
		}	
